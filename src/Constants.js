...
export const SKILLS = [
  ...
  { name: "Tailwind CSS", initialRating: 4 },
  { name: "Bootstrap | ReactStrap | Material UI", initialRating: 4 },
];

export const TOOLS = ["Visual Studio Code", "Git", "Browser DevTools", "Npm (Node Package Manager)", "Postman"]
